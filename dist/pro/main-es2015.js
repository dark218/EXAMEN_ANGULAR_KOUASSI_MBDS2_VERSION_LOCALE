...
let AuthService = class AuthService {
    ...
    login(email, password) {
        ...
        this.http.post("https://examenangularmongokouassi.herokuapp.com//api/user/login", authData)
            .subscribe(response => {
    ...
    getUser() {
        this.http.get('https://examenangularmongokouassi.herokuapp.com//api/user/getUserData')
