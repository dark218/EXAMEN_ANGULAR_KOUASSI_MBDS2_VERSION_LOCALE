      ...
      var AuthService = /*#__PURE__*/function () {
        ...
        _createClass(AuthService, [{
          ...
          value: function createUser(name, email, password) {
            ...
            this.http.post(this.url + '/signup', authData).subscribe(function (response) {
          ...
          value: function login(email, password) {
            ...
            this.http.post(this.url + 'login', authData).subscribe(function (response) {
          ...
          value: function getUser() {
            ...
            this.http.get(this.url + 'getUserData').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (userData) {
          ...
          value: function updateUser(id, name, email, password) {
            ...
            this.http.put(this.url + id, user).subscribe(function (response) {
          ...
          value: function deleteUser(userId) {
            ...
            this.http["delete"](this.url + userId).subscribe(function () {
